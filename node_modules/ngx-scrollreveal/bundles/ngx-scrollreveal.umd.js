(function (global, factory) {
    ...
    (factory((global.ngxScrollreveal = {}),global.ng.core,global.rxjs,global.ng.common));
    ...
    var NgsRevealConfig = /** @class */ (function () {
        ...
        /** @nocollapse */ NgsRevealConfig.ngInjectableDef = i0.defineInjectable({ factory: function NgsRevealConfig_Factory() { return new NgsRevealConfig(); }, token: NgsRevealConfig, providedIn: "root" });
    ...
    var NgsRevealService = /** @class */ (function () {
        function NgsRevealService(config, windowService) {
            // Observable  sources
            this.beforeRevealSource = new rxjs.Subject();
            this.afterRevealSource = new rxjs.Subject();
            this.beforeResetSource = new rxjs.Subject();
            this.afterResetSource = new rxjs.Subject();
            // Observable  streams
       ...
       */
        ...
        /** @nocollapse */ NgsRevealService.ngInjectableDef = i0.defineInjectable({ factory: function NgsRevealService_Factory() { return new NgsRevealService(i0.inject(NgsRevealConfig), i0.inject(WindowService)); }, token: NgsRevealService, providedIn: "root" });
    ...
    var NgsRevealDirective = /** @class */ (function (_super) {
        ...
        NgsRevealDirective.propDecorators = {
            "visibility": [{ type: i0.HostBinding, args: ['style.visibility',] },],
            "_config": [{ type: i0.Input, args: ['ngsReveal',] },],
        };
    ...
    var NgsRevealSetDirective = /** @class */ (function (_super) {
        ...
        NgsRevealSetDirective.propDecorators = {
            "_config": [{ type: i0.Input, args: ['ngsRevealSet',] },],
            "ngsSelector": [{ type: i0.Input },],
            "ngsInterval": [{ type: i0.Input },],
            "ngsSync": [{ type: i0.Input },],
        };
    ...
    exports.ɵa = AbstractNgsRevealDirective;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ngx-scrollreveal.umd.js.map
